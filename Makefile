...
j2y:
	go build github.com/secDre4mer/gyp/cmd/j2y

y2j:
	go build github.com/secDre4mer/gyp/cmd/y2j

release:
	GOOS=linux go build -o y2j-linux github.com/secDre4mer/gyp/cmd/y2j
	GOOS=darwin go build -o y2j-mac github.com/secDre4mer/gyp/cmd/y2j
	GOOS=windows go build -o y2j.exe github.com/secDre4mer/gyp/cmd/y2j
